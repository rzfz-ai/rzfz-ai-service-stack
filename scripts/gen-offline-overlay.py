...
TELEMETRY_OFF = {
    ...
    # #2332: speaches (STT/TTS) loads faster-whisper/piper through huggingface_hub and
    # reaches huggingface.co on model load even with the models on disk; under an egress
    # cut the load hangs (0.79, 2026-09-20: STT stuck at ~1% CPU behind a HTTPS connect).
    # Never set at 2026.08-ga.15 either — a pre-existing air-gap gap, closed here.
    "speaches":          {"HF_HUB_OFFLINE": "1", "TRANSFORMERS_OFFLINE": "1", "HF_HUB_DISABLE_TELEMETRY": "1", "DO_NOT_TRACK": "1"},
...
HF_LOADERS = ("openwebui", "gpustack", "gpustack-legacy", "gpustack-cpu",
              ...
              "speaches",  # #2332: loads whisper/piper via huggingface_hub
