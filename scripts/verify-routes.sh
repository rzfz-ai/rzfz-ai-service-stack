...
ROUTES=(
    ...
    "llm-cpu,llm-box,llm-experimental|llm.${MAIN_DOMAIN}|gpustack|9090|/healthz"
    ...
    "moltis|moltis.${MAIN_DOMAIN}|moltis|13131|/health"
    "hermes|hermes.${MAIN_DOMAIN}|hermes-agent|3101|/health"
    ...
    "coding-tools|coding.${MAIN_DOMAIN}|coding-tools|3004|"
