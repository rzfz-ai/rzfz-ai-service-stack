...
SILENT "empty knowledge-graph" failures that appear after a cognee 0.16 -> 0.17
(ladybug/Kuzu) upgrade into a safe, reversible migration (Defect 1) and a loud,
actionable warning (Defect 2).

Root cause of the silence (cognee 1.2.2 / 1.4.0):
