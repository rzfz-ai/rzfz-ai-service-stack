...
- The cycle's outbound-request surfaces are hardened: the MCP manager constrains OAuth/proxy
...
- **GA full Mode-A compliance audit (NIS2 / ISO 27001:2022 / OWASP LLM Top 10):**
  ...
  Report: available from your razzfazz.ai support contact on request.
