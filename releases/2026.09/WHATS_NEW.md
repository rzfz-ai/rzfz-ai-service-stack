...
- **2026.09-ga.3:** fresh installations complete again.
- **2026.09-ga.2:** the upgrade from 2026.08 carries saved Dify apps, knowledge bases, database roles and cognee data across, and retrieval uses the embedding space the documents were indexed in.
- **2026.09-ga.1:** a stalled model download resumes and retries; the first install from the public mirror ends with its models in place.
