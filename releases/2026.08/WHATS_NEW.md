...
> **Patch v2026.08-ga.14 (2026-08-21):** **Chat works again.** OpenWebUI chat was hanging
> with no answer on every box — its live token stream was being caught by the single-sign-on
> layer. Fixed. The admin-password tool also stopped reporting success when a new password
> didn't actually take on some services, changing a box's domain no longer breaks the login
> button, and the getting-started PDF is back to two pages.
