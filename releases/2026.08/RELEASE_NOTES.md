...
**Cycle status:** GA — latest `v2026.08-ga.13` (2026-08-20); `v2026.08-ga.12` (2026-08-13); `v2026.08-ga.11` (2026-08-06); `v2026.08-ga.10` (2026-08-05); `v2026.08-ga.9` (2026-08-03); `v2026.08-ga.8` (2026-08-03); `v2026.08-ga.7` (2026-08-02);
...
Per-tag notes: `releases/2026.08-ga.13/`, `releases/2026.08-ga.12/`, `releases/2026.08-ga.11/`, `releases/2026.08-ga.9/`, `releases/2026.08-ga.8/`, `releases/2026.08-ga.7/`, `releases/2026.08-ga.6/`, `releases/2026.08-ga.5/`, `releases/2026.08-ga.4/`, `releases/2026.08-ga.3/`, `releases/2026.08-ga.1/`, `releases/2026.08-ga/`.
...
**Security.** Four forged-header / CSRF holes closed. The Configuration Portal (#377) and
agent-manager's `/api`, admin, dashboard and terminal WebSocket (#390, #397) all authorised
on `X-Authentik-*` headers with no proof the request came through Caddy — and those
containers share the compose default network with every other service, so any peer with an
SSRF foothold could forge an admin identity. On the portal that reaches `/secrets`,
`/secrets/regenerate`, the module toggles and backup/restore. #384 replaces a `!=` CSRF
token comparison (timing leak) with `secrets.compare_digest`. Also #388 and #378.
