...
PROFILES = ["chat", "dify", "gotenberg", "llm-cpu", "llm-box", "llm-experimental", "monitor", "searxng", "stts", "gitea", "lightrag", "cognee", "tika", "docling", "presidio", "stirling-pdf", "paperclip", "moltis", "hermes", "matrix", "paperless-ngx", "vaultwarden", "infisical", "onyx", "openhands", "coding-tools"]
...
class ConfigManager:
    ...
    def get_editable_config(self):
        ...
        return {
            ...
            "profiles": {
                p: (p in env_config.get("COMPOSE_PROFILES", "").split(",")) for p in PROFILES
            },
            "lightrag": {
            ...
            "cognee": {
                ...
                "COGNEE_EMBEDDING_DIM": env_config.get("COGNEE_EMBEDDING_DIM", "768"),
            }
        }
    ...
    def update_config(self, data):
        ...
        # Global
        if 'MAIN_DOMAIN' in data: updates['MAIN_DOMAIN'] = data['MAIN_DOMAIN']
        if 'TZ' in data:
            updates['TZ'] = data['TZ']
        ...
        for p in PROFILES:
            if data.get(f"profile_{p}") == 'on':
                profiles.append(p)
        
        if _has_profile_toggles:
            updates['COMPOSE_PROFILES'] = ",".join(profiles)
        ...
        # Dify specific handling if needed (update Dify envs)
        # if 'dify' in profiles: ...
    ...
    def get_cognee_config(self) -> dict:
        ...
        return {
            ...
            "embedding_dim": env_config.get("COGNEE_EMBEDDING_DIM", "768"),
    ...
    def get_gpustack_models() -> list:
        ...
        try:
            req = urllib.request.Request(
                "http://gpustack:9090/v1-openai/models",
